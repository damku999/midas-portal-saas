...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('central.blog-posts.update', $blogPost) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                           id="slug" name="slug" value="{{ old('slug', $blogPost->slug) }}" readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('excerpt') is-invalid @enderror"
                                              id="excerpt" name="excerpt" rows="3" maxlength="500" required>{{ old('excerpt', $blogPost->excerpt) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" style="display:none;" required>{{ old('content', $blogPost->content) }}</textarea>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                                   id="meta_title" name="meta_title" value="{{ old('meta_title', $blogPost->meta_title) }}" maxlength="60">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                                      id="meta_description" name="meta_description" rows="2" maxlength="160">{{ old('meta_description', $blogPost->meta_description) }}</textarea>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                                ...
                                                <option value="product-updates" {{ old('category', $blogPost->category) === 'product-updates' ? 'selected' : '' }}>Product Updates</option>
                                                <option value="insurance-tips" {{ old('category', $blogPost->category) === 'insurance-tips' ? 'selected' : '' }}>Insurance Tips</option>
                                                <option value="claims" {{ old('category', $blogPost->category) === 'claims' ? 'selected' : '' }}>Claims</option>
                                                <option value="insurance-types" {{ old('category', $blogPost->category) === 'insurance-types' ? 'selected' : '' }}>Insurance Types</option>
                                                <option value="addons" {{ old('category', $blogPost->category) === 'addons' ? 'selected' : '' }}>Add-ons</option>
                                            </select>
                                            @error('category')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('tags') is-invalid @enderror"
                                                   id="tags" name="tags" value="{{ old('tags', is_array($blogPost->tags) ? implode(', ', $blogPost->tags) : $blogPost->tags) }}" placeholder="tag1, tag2, tag3">
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <input type="number" class="form-control @error('reading_time_minutes') is-invalid @enderror"
                                                   id="reading_time_minutes" name="reading_time_minutes" value="{{ old('reading_time_minutes', $blogPost->reading_time_minutes) }}" min="1">
                                ...
                                <div class="card mb-3 bg-light">
                                    <div class="card-body">
                                        <div class="mb-2">
                                            ...
                                            <div>{{ $blogPost->created_at->format('M d, Y H:i') }}</div>
                                        </div>
                                        <div class="mb-2">
                                            <small class="text-muted">Last Updated:</small>
                                            <div>{{ $blogPost->updated_at->format('M d, Y H:i') }}</div>
                                        </div>
                                        @if($blogPost->published_at)
                                            <div class="mb-2">
                                                <small class="text-muted">Published:</small>
                                                <div>{{ $blogPost->published_at->format('M d, Y H:i') }}</div>
                                            </div>
                                        @endif
                                        <div class="mb-0">
                                            <small class="text-muted">Views:</small>
                                            <div>{{ number_format($blogPost->views_count) }}</div>
                                        </div>
                                    </div>
                                </div>
