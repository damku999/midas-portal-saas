...
<section class="py-5" style="background: var(--gradient-primary); color: white;">
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-3 fw-bold mb-4">Staff & Role Management</h1>
                <p class="lead mb-4">Manage your team with powerful role-based access control. Create custom roles, assign granular permissions, track user activities, and monitor performance metrics to optimize team productivity.</p>
...
<section class="py-5" style="background: var(--gradient-primary); color: white;">
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="display-4 fw-bold mb-4">Ready to Empower Your Team?</h2>
