...
@include('public.components.cta-section', [
    ...
    'description' => 'Group and manage family members with their insurance policies in one organized view. Simplify family policy management, track dependents, and provide consolidated access to all family insurance needs.',
...
<!-- CTA Section -->
@include('public.components.cta-section', [
    'title' => 'Ready to Simplify Family Insurance Management?',
