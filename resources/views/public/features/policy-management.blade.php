...
@include('public.components.cta-section', [
    ...
    'description' => 'Manage all insurance types with complete lifecycle tracking from issuance to renewal. Automate premium calculations, track NCB, and never miss a renewal with intelligent reminder systems.',
...
<!-- CTA Section -->
@include('public.components.cta-section', [
    'title' => 'Ready to Streamline Policy Management?',
