...
<section class="py-5" style="background: var(--gradient-primary); color: white;">
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-3 fw-bold mb-4">Commission Tracking</h1>
                <p class="lead mb-4">Automate commission calculations with multi-level support for own, transfer, and reference commissions. Track payments, generate reports, and ensure accurate agent payouts with built-in TDS calculations.</p>
...
<section class="py-5" style="background: var(--gradient-primary); color: white;">
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="display-4 fw-bold mb-4">Ready to Automate Commission Tracking?</h2>
