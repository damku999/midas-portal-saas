...
class SecureStoreCustomerRequest extends SecureFormRequest
{
    /**
    ...
    {
        return auth()->check() && auth()->user()->can('customer-create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => ['required', $this->getSecureEmailRules('customers', 'email')],
    ...
    /**
     * Enhanced error messages for customer creation.
     */
